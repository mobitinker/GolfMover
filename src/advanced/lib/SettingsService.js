...
const APP_SETTINGS = [
  ...
  {show: true, name: 'radius', group: 'geofence', dataType: 'integer', inputType: 'select', defaultValue: 20, values: [20, 100, 150, 200, 500, 1000]},
  {show: true, name: 'notifyOnEntry', group: 'geofence', dataType: 'boolean', inputType: 'toggle', defaultValue: true},
  {show: true, name: 'notifyOnExit', group: 'geofence', dataType: 'boolean', inputType: 'toggle', defaultValue: false},
  {show: true, name: 'notifyOnDwell', group: 'geofence', dataType: 'boolean', inputType: 'toggle', defaultValue: false},
...
const PLUGIN_SETTINGS = {
  common: [
    // Geolocation
    {show: true, name: 'desiredAccuracy', group: 'geolocation', dataType: 'integer', inputType: 'select', values: [-1, 0, 10, 100, 1000], defaultValue: 10 },
    ...
    {show: false, name: 'maxBatchSize', group: 'http', dataType: 'integer', inputType: 'select', values: [-1, 50, 100, 250, 500], defaultValue: 250},
